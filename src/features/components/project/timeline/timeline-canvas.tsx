  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        ...
        {showToday && (
          <div
            className="pointer-events-none absolute top-0 z-10 w-px bg-rose-500"
            style={{
              left:   todayOffset * DAY_W + DAY_W / 2,
              height: totalGroupsHeight,
            }}
          >
            <div className="absolute left-1/2 top-0 -translate-x-1/2 whitespace-nowrap rounded-b-md bg-rose-500 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-white shadow-lg">
              Today
            </div>
          </div>
        )}
                ...
                {group.sprint ? (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div
                        className="absolute flex cursor-default items-center gap-2 overflow-hidden rounded-md border border-primary/30 bg-primary/10 px-3 transition-colors hover:bg-primary/15"
                        style={{
                          top:    (SPRINT_H - 28) / 2,
                          height: 28,
                      ...
                      <Tooltip key={issue.id}>
                        <TooltipTrigger asChild>
                          ...
                          >
                            ...
                            {/* Duration badge */}
                            {durationDays > 3 && (
                              <span className="ml-auto mr-1.5 shrink-0 rounded bg-black/25 px-1 py-px text-[9px] font-bold text-white/90">
                                {durationDays}d
                              </span>
                            )}
                          </div>
